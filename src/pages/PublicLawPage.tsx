...
const RESOURCES = {
  ...
  bodies: [
    { name: 'Public Law Project', url: 'https://publiclawproject.org.uk/' },
    { name: 'Administrative Law Bar Association', url: 'https://www.adminlaw.org.uk/' },
    { name: 'Liberty', url: 'https://www.libertyhumanrights.org.uk/' },
    { name: 'Justice', url: 'https://justice.org.uk/' },
  ],
  localGov: [
    { name: 'Local Government Association', url: 'https://www.local.gov.uk/' },
    { name: 'LG Ombudsman', url: 'https://www.lgo.org.uk/' },
    { name: 'Local Government Lawyer', url: 'https://www.localgovernmentlawyer.co.uk/' },
    { name: 'CIPFA', url: 'https://www.cipfa.org/' },
  ],
  humanRights: [
    { name: 'Equality & Human Rights Commission', url: 'https://www.equalityhumanrights.com/' },
    { name: 'ECHR Caselaw', url: 'https://hudoc.echr.coe.int/' },
    { name: 'UN Human Rights', url: 'https://www.ohchr.org/' },
    { name: 'Amnesty UK', url: 'https://www.amnesty.org.uk/' },
  ],
  ombudsmen: [
